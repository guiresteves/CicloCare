                          ...
                          GestureDetector(
                            onTap: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Foto mockada — funcionalidade em breve'),
                ...
                children: [
                  ...
                  _SectionCard(
                    ...
                    children: [
                      ...
                      _InfoRow(label: 'Nascimento',  value: birth, isLast: true),
                    ],
                  ),
                  const SizedBox(height: 16),
                  ...
                  _SectionCard(
                    ...
                    children: [
                      _SwitchRow(
                        ...
                        value: _notifMed,
                        onChanged: (v) => setState(() => _notifMed = v)),
                      _SwitchRow(
  ...
  Widget build(BuildContext context) => Column(children: [
    Padding(
      ...
      child: Row(children: [
        ...
        Switch(value: value, activeColor: AppColors.primary,
          onChanged: onChanged),
      ]),
    ),
